...
public class DesktopMenuPluginTest
{
	...
	public void testPlugin()
	{
		...
		List<DesktopMenuExtensionPoint> extensionPoints = pluginManager.getExtensions(DesktopMenuExtensionPoint.class);
		...
		assertTrue(extensionClassNames.contains("io.github.astrapi69.menu.pf4j.extension.DesktopMenuExtension"));
